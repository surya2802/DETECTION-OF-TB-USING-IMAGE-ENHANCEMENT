...
% Last Modified by GUIDE v2.5 28-Apr-2022 12:51:29
...
% handles    structure with handles and user data (see GUIDATA)
global train 
matlabpath ='C:\Users\karth\Desktop\tuber matlab\'
...
layers = [ imageInputLayer([400 400 3])
...
global inp
cd input
[file path] = uigetfile('*.bmp;*.jpg;*.jpeg','Pick an Image File');
